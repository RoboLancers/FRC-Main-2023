...
public class MidLaneAutoTaxi extends SequentialCommandGroup {
    public MidLaneAutoTaxi(Drivetrain drivetrain, Gyro gyro, Arm arm, Intake intake, Constants.Arm.ScoringPosition position) {
        // addCommands(
